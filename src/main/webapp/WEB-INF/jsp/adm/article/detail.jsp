...
<section class="section-1">
	...
	<div class="bg-white shadow-md rounded container mx-auto p-8 mt-8">
		<div class="w-full">
			...
			<div class="text-gray-600 font-semibold text-lg my-4">${article.title}</div>
			...
			<div class="flex w-full border-t border-gray-100">
				...
				<div class="mt-3 w-full flex justify-end">
					<c:if test="${ like.id == null}">
						<a href="AddLike?relTypeCode=article"><i
			...
			<div
				...
				<form onsubmit="AddReply__checkAndSubmit(this); return false;" action="doAddReply" method="POST">
					<input type="search" class="w-full py-2 pl-4 pr-10 text-sm bg-gray-100 border border-transparent appearance-none rounded-tg placeholder-gray-400 focus:bg-white focus:outline-none focus:border-blue-500 focus:text-gray-900 focus:shadow-outline-blue"
						style="border-radius: 25px" placeholder="댓글을 입력해주세요." autocomplete="off" name="body">
